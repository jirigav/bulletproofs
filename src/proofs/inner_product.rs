...
impl InnerProductArg {
    pub fn prove(
        ...
        if n != 1 {
            ...
            let ux_CL: Point<Secp256r1> = ux * &c_L_fe;
            ...
            let ux_CR: Point<Secp256r1> = ux * &c_R_fe;
    ...
    pub fn verify(
        ...
        let a_fe = Scalar::<Secp256r1>::from(&self.a_tag);
        let b_fe = Scalar::<Secp256r1>::from(&self.b_tag);
        let c = &a_fe * &b_fe;
        let Ga = &G[0] * &a_fe;
        let Hb = &H[0] * &b_fe;
        let ux_c = ux * &c;
...
mod tests {
    ...
    //use curv::elliptic::curves::p256::hash_to_curve::generate_random_point;
    ...
    fn test_helper(n: usize) {
        ...
        let ux_c: Point<Secp256r1> = &Gx * &c_fe;
        let a_G = (0..n)
            .map(|i| {
                let ai = Scalar::<Secp256r1>::from(&a[i]);
                &g_vec[i] * &ai
            })
            .fold(ux_c, |acc, x: Point<Secp256r1>| acc + x as Point<Secp256r1>);
        let P = (0..n)
            .map(|i| {
